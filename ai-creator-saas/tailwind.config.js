  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'upload-bounce': 'uploadBounce 1s ease-in-out infinite',
      ...
      keyframes: {
        ...
        pulseNeon: {
          '0%, 100%': { 
            boxShadow: '0 0 5px #C084FC, 0 0 10px #C084FC, 0 0 15px #C084FC',
            transform: 'scale(1)'
          },
          '50%': { 
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'linear-gradient(135deg, #C084FC 0%, #60A5FA 50%, #A3E635 100%)',
      ...
      boxShadow: {
        'neon': '0 0 5px #C084FC, 0 0 10px #C084FC, 0 0 15px #C084FC',
        'neon-blue': '0 0 5px #60A5FA, 0 0 10px #60A5FA, 0 0 15px #60A5FA',
        'neon-green': '0 0 5px #A3E635, 0 0 10px #A3E635, 0 0 15px #A3E635',
        'glass': '0 8px 32px 0 rgba(31, 38, 135, 0.37)',
        'card': '0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
        'card-hover': '0 20px 40px -10px rgba(0, 0, 0, 0.2), 0 8px 12px -4px rgba(0, 0, 0, 0.1)',
        'inner-glow': 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.06)',
      },
      dropShadow: {
        'neon': '0 0 10px #C084FC',
